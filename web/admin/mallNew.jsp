...
<html:html lang="true">
    ...
    <div class="admin_content">
        ...
        <div class="admin_work">
                ...
                <html:form styleId="myForm" action="admin/mallNewAction.do" method="post" enctype="multipart/form-data">
                    
                <h3><bean:message key="admin.title.newMall"/></h3>
                
                <div class="formulario">
                    <div class="row">
                        <div class="col3"><bean:message key="admin.mallNew.label"/></div>
                        <div class="col9"><input type="text" name="name" id="name" class="input_full" required placeholder="<bean:message key="admin.mall.name.input.placeholder"/>"></div> 
                    </div>                                 
