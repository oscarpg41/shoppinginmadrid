...
<html:html lang="true">
    ...
    <div class="admin_content">
        ...
        <div class="admin_work">
            ...
            <form id="formInformation" action="departmentDeleteAction.do" method="post">
                <h3><bean:message key="admin.title.deleteDepartment"/></h3>
                
                <div class="formulario">
                        <div class="row">
                            <div class="col4"><bean:message key="admin.department.select.label"/></div>
                            <div class="col8">
