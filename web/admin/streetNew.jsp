...
<html:html lang="true">
    ...
    <div class="admin_content">
        ...
        <div class="admin_work">
            ...
            <form id="formNewArea" action="streetNewAction.do" method="post">
                <h3><bean:message key="admin.title.newStreet"/></h3>
                
                <div class="formulario">
                    <div class="row">
                        <div class="col4"><bean:message key="admin.streetNew.label"/></div>
                        <div class="col8"><input type="text" class="input_full" name="name" required placeholder="<bean:message key="admin.street.name.input.placeholder"/>"></div>
                    </div>
