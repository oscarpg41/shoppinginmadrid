...
<html:html lang="true">
    ...
    <div class="admin_content">
        ...
        <div class="admin_work">
            ...
            <html:form styleId="myForm" action="admin/mallUpdateAction.do" method="post" enctype="multipart/form-data">                                
                <h3><bean:message key="admin.title.updateMall"/></h3>
                
                <div class="formulario">
                        <div class="row">
                            <div class="col4"><bean:message key="admin.mall.select.label"/></div>
                            <div class="col8">
                                <select name="idMall" id="idMall" required >
                                    <option></option>
                                    <%=listadoCC%>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col3"><bean:message key="admin.mallNew.label"/></div>
                            <div class="col9"><input type="text" name="name" id="name" class="input_full" disabled required placeholder="<bean:message key="admin.mall.name.input.placeholder"/>" ></div> 
                        </div>        
                   <div class="row">
    ...
    <script>
        ...
        $('#idMall').on('change', cambiaMallByAjax);        
