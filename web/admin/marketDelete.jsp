...
<html:html lang="true">
    ...
    <div class="admin_content">
        ...
        <div class="admin_work">
            ...
            <form id="formInformation" action="marketDeleteAction.do" method="post">
                <h3><bean:message key="admin.title.deleteMarket"/></h3>
                
                <div class="formulario">
                        <div class="row">
                            <div class="col4"><bean:message key="admin.market.select.label"/></div>
                            <div class="col8">
    ...
    <script>mostrarSubMenuMarket();</script>
    <script>
