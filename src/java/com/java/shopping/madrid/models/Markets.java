 ...
 */
public class Markets extends ActionForm implements java.io.Serializable {
    ...
    public Markets(String name, String street, String number, int zip, int idArea, String web,  String metro, String descriptionEs, String descriptionEn, String maps) {
       this.name = name;
       this.street = street;
       this.number = number;
       this.zip = zip;
